...
\label{subsec:Sec043}
\noindent Routing int IGP prefers route through WAN1, after outage it takes about 5 second to change route
\InsertFigure{Figures/Reconvergence/IPv4.png}{0.75\textwidth}{IPv4 reconvergence}
\InsertFigure{Figures/Reconvergence/IPv6.png}{0.75\textwidth}{IPv6 reconvergence}
